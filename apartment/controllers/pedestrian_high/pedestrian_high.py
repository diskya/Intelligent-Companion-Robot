...
class Pedestrian (Supervisor):
    ...
    def __init__(self):
        ...
        self.speed = 1.15
        self.current_height_offset = 1.27
        ...
        self.height_offsets = [  # those coefficients are empirical coefficients which result in a realistic walking gait 4.92, 4.99, 5.03, 4.93, 4.92, 4.99, 5.03, 4.93
            0, 0.07, 0.11, 0.01, 0, 0.07, 0.11, 0.01
        ]
